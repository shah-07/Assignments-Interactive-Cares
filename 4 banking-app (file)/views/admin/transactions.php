                  ...
                  <table class="min-w-full divide-y divide-gray-300">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                      <?php foreach ($transactions as $transaction): ?>
                        <tr>
                          <td class="whitespace-nowrap px-2 py-4 text-sm text-gray-800">
                            <?= htmlspecialchars($transaction['name']) ?>
                          </td>
                          <td
                            class="whitespace-nowrap px-2 py-4 text-sm font-medium <?= $transaction['amount'][0] === '+' ? 'text-emerald-600' : 'text-red-600' ?>">
