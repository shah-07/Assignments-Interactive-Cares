                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                      ...
                      foreach ($transactions as $transaction) {
                        ...
                        if ($transaction['type'] === 'Deposit' || $transaction['type'] === 'Received') {
                          ...
                          echo '<tr>
                                  <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm text-gray-800 sm:pl-0">' . htmlspecialchars($transaction['receivername']) . '</td>
                                  <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm text-gray-500 sm:pl-0">' . htmlspecialchars($transaction['email']) . '</td>
